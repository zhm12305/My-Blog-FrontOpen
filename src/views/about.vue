...
.author-content-item.map {
  background: url(https://picsum.photos/800/600?random=19) no-repeat
    center;
  min-height: 200px;
  max-height: 400px;
  position: relative;
...
.author-content-item.maxim {
  ...
  display: flex;
  color: var(--favoriteBg);
  background: url(https://picsum.photos/800/600?random=20)
    no-repeat;
  background-size: cover;
  align-items: flex-start;
  flex-direction: column;
...
.author-content-item.myphoto {
  background: url(https://picsum.photos/800/600?random=21)
    no-repeat;
  height: 60%;
  background-size: 100%;
...
.author-content-item.game-lol {
  background: url(https://picsum.photos/800/600?random=22)
    no-repeat top;
  background-size: cover;
  min-height: 300px;
  overflow: hidden;
...
.author-content-item.game-wolf {
  border: 1px;
  width: 56%;
  background: url(https://picsum.photos/800/600?random=23)
    no-repeat top;
  background-size: cover;
  min-height: 300px;
  overflow: hidden;
...
.author-content-item.like-technology {
  border: 1px;
  background: url(https://picsum.photos/800/600?random=24)
    no-repeat;
  background-size: cover;
  min-height: 230px;
  color: var(--red);
...
.author-content-item.like-music {
  border: 1px;
  background: url(https://picsum.photos/800/600?random=25)
    no-repeat top;
  background-size: cover;
  min-height: 400px;
  color: var(--orange1);
